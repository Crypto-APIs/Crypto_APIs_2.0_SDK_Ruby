  ...
  class CreateCoinsTransactionRequestFromAddressRI
    ...
    def self.openapi_types
      {
        ...
        :'fee_priority' => :'String',
        :'note' => :'String',
        :'recipients' => :'Array<CreateCoinsTransactionRequestFromAddressRIRecipientsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::CreateCoinsTransactionRequestFromAddressRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::CreateCoinsTransactionRequestFromAddressRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'address_tag')
        self.address_tag = attributes[:'address_tag']
      end
    ...
    def hash
      [address_tag, callback_secret_key, callback_url, classic_address, fee_priority, note, recipients, senders, transaction_request_id, transaction_request_status].hash
    end
