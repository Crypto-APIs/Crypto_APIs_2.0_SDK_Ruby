...
# Unit tests for OpenapiClient::TokensForwardingFailDataItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TokensForwardingFailDataItem do
  let(:instance) { OpenapiClient::TokensForwardingFailDataItem.new }
  ...
  describe 'test an instance of TokensForwardingFailDataItem' do
    it 'should create an instance of TokensForwardingFailDataItem' do
      expect(instance).to be_instance_of(OpenapiClient::TokensForwardingFailDataItem)
    end
  end
