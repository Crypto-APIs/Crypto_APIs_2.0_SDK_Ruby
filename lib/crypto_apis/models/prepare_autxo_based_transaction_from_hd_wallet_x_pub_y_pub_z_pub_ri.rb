  ...
  class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRI
    ...
    def self.openapi_types
      {
        ...
        :'replaceable' => :'Boolean',
        :'size' => :'Integer',
        :'vin' => :'Array<PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner>',
        :'vout' => :'Array<PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVoutInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @replaceable.nil?
        invalid_properties.push('invalid value for "replaceable", replaceable cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @replaceable.nil?
    ...
    def hash
      [additional_data, fee, fee_per_byte, locktime, replaceable, size, vin, vout].hash
    end
