...
module CryptoApis
  class CreateSubscriptionsForApi
    ...
    # @option opts [BlockHeightReachedRB] :block_height_reached_rb 
    # @return [BlockHeightReachedR]
    def block_height_reached(blockchain, network, opts = {})
      data, _status_code, _headers = block_height_reached_with_http_info(blockchain, network, opts)
      data
    end
    ...
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [BlockHeightReachedRB] :block_height_reached_rb 
    # @return [Array<(BlockHeightReachedR, Integer, Hash)>] BlockHeightReachedR data, response status code and response headers
    def block_height_reached_with_http_info(blockchain, network, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CreateSubscriptionsForApi.block_height_reached ...'
      end
      # verify the required parameter 'blockchain' is set
      if @api_client.config.client_side_validation && blockchain.nil?
        fail ArgumentError, "Missing the required parameter 'blockchain' when calling CreateSubscriptionsForApi.block_height_reached"
      end
      # verify enum value
      allowable_values = ["bitcoin", "bitcoin-cash", "dash", "dogecoin", "zcash", "litecoin", "ethereum", "ethereum-classic", "binance-smart-chain", "xrp", "zilliqa", "tron", "polygon"]
      ...
      if @api_client.config.client_side_validation && network.nil?
        fail ArgumentError, "Missing the required parameter 'network' when calling CreateSubscriptionsForApi.block_height_reached"
      end
      # verify enum value
      ...
      # resource path
      local_var_path = '/blockchain-events/{blockchain}/{network}/subscriptions/block-height-reached'.sub('{' + 'blockchain' + '}', CGI.escape(blockchain.to_s)).sub('{' + 'network' + '}', CGI.escape(network.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'block_height_reached_rb'])

      # return_type
      return_type = opts[:debug_return_type] || 'BlockHeightReachedR'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"CreateSubscriptionsForApi.block_height_reached",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreateSubscriptionsForApi#block_height_reached\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def mined_transaction_with_http_info(blockchain, network, opts = {})
      ...
      # verify enum value
      allowable_values = ["bitcoin", "bitcoin-cash", "litecoin", "dogecoin", "dash", "ethereum", "ethereum-classic", "xrp", "zilliqa", "binance-smart-chain", "zcash", "tron", "polygon"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedCoinsTransactionsForSpecificAmountRB] :new_confirmed_coins_transactions_for_specific_amount_rb 
    ...
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedCoinsTransactionsForSpecificAmountRB] :new_confirmed_coins_transactions_for_specific_amount_rb 
    # @return [Array<(NewConfirmedCoinsTransactionsForSpecificAmountR, Integer, Hash)>] NewConfirmedCoinsTransactionsForSpecificAmountR data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedInternalTransactionsForSpecificAmountRB] :new_confirmed_internal_transactions_for_specific_amount_rb 
    ...
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedInternalTransactionsForSpecificAmountRB] :new_confirmed_internal_transactions_for_specific_amount_rb 
    # @return [Array<(NewConfirmedInternalTransactionsForSpecificAmountR, Integer, Hash)>] NewConfirmedInternalTransactionsForSpecificAmountR data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedTokenTransactionsForSpecificAmountRB] :new_confirmed_token_transactions_for_specific_amount_rb 
    ...
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @option opts [NewConfirmedTokenTransactionsForSpecificAmountRB] :new_confirmed_token_transactions_for_specific_amount_rb 
    # @return [Array<(NewConfirmedTokenTransactionsForSpecificAmountR, Integer, Hash)>] NewConfirmedTokenTransactionsForSpecificAmountR data, response status code and response headers
    ...
    def new_confirmed_tokens_transactions_with_http_info(blockchain, network, opts = {})
      ...
      # verify enum value
      allowable_values = ["bitcoin", "ethereum", "ethereum-classic", "binance-smart-chain", "tron", "polygon"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
    ...
    def new_unconfirmed_coins_transactions_with_http_info(blockchain, network, opts = {})
      ...
      # verify enum value
      allowable_values = ["bitcoin", "bitcoin-cash", "litecoin", "dogecoin", "dash", "ethereum", "ethereum-classic", "binance-smart-chain", "zcash", "polygon"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
    ...
    def new_unconfirmed_tokens_transactions_with_http_info(blockchain, network, opts = {})
      ...
      # verify enum value
      allowable_values = ["bitcoin", "ethereum", "ethereum-classic", "polygon"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
