...
module CryptoApis
  class BlockHeightReachedRI
    ...
    attr_accessor :block_height_reached
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::BlockHeightReachedRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::BlockHeightReachedRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'block_height_reached')
        self.block_height_reached = attributes[:'block_height_reached']
      end
    ...
    def list_invalid_properties
      ...
      if @block_height_reached.nil?
        invalid_properties.push('invalid value for "block_height_reached", block_height_reached cannot be nil.')
      end
    ...
    def valid?
      return false if @block_height_reached.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          block_height_reached == o.block_height_reached &&
    ...
    def hash
      [block_height_reached, callback_secret_key, callback_url, created_timestamp, is_active, reference_id].hash
    end
