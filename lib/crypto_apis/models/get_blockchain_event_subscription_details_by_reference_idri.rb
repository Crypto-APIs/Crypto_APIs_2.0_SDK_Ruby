...
module CryptoApis
  class GetBlockchainEventSubscriptionDetailsByReferenceIDRI
    ...
    attr_accessor :deactivation_reasons
    ...
    def self.openapi_types
      {
        ...
        :'deactivation_reasons' => :'Array<ListBlockchainEventsSubscriptionsRIDeactivationReasonsInner>',
        :'event_type' => :'String',
        :'is_active' => :'Boolean',
        :'network' => :'String',
        :'reference_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::GetBlockchainEventSubscriptionDetailsByReferenceIDRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::GetBlockchainEventSubscriptionDetailsByReferenceIDRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deactivation_reasons')
        if (value = attributes[:'deactivation_reasons']).is_a?(Array)
          self.deactivation_reasons = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deactivation_reasons == o.deactivation_reasons &&
    ...
    def hash
      [address, blockchain, callback_secret_key, callback_url, confirmations_count, created_timestamp, deactivation_reasons, event_type, is_active, network, reference_id, transaction_id].hash
    end
