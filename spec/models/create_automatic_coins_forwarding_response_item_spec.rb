...
# Unit tests for CryptoApis::CreateAutomaticCoinsForwardingResponseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::CreateAutomaticCoinsForwardingResponseItem do
  let(:instance) { CryptoApis::CreateAutomaticCoinsForwardingResponseItem.new }
  ...
  describe 'test an instance of CreateAutomaticCoinsForwardingResponseItem' do
    it 'should create an instance of CreateAutomaticCoinsForwardingResponseItem' do
      expect(instance).to be_instance_of(CryptoApis::CreateAutomaticCoinsForwardingResponseItem)
    end
  end
