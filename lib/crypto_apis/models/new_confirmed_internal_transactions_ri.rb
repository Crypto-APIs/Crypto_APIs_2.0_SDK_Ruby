...
module CryptoApis
  class NewConfirmedInternalTransactionsRI
    ...
    attr_accessor :receive_callback_on
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::NewConfirmedInternalTransactionsRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::NewConfirmedInternalTransactionsRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'receive_callback_on')
        self.receive_callback_on = attributes[:'receive_callback_on']
      end
    ...
    def list_invalid_properties
      ...
      if @receive_callback_on.nil?
        invalid_properties.push('invalid value for "receive_callback_on", receive_callback_on cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @receive_callback_on.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          receive_callback_on == o.receive_callback_on &&
    ...
    def hash
      [address, callback_secret_key, callback_url, created_timestamp, event_type, is_active, receive_callback_on, reference_id].hash
    end
