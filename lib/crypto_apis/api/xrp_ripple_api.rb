...
module CryptoApis
  class XRPRippleApi
    ...
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @option opts [String] :transaction_type Defines the transaction type.
    # @return [Array<(ListXRPRippleTransactionsByAddressAndTimeRangeR, Integer, Hash)>] ListXRPRippleTransactionsByAddressAndTimeRangeR data, response status code and response headers
