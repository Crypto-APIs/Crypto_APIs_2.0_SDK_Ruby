...
module CryptoApis
  class GenerateAddressRI
    ...
    def self.openapi_types
      {
        :'addresses' => :'Array<GenerateAddressRIAddresses>',
        :'private_key' => :'String',
        :'public_key' => :'String',
        :'wif' => :'String'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::GenerateAddressRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::GenerateAddressRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'wif')
        self.wif = attributes[:'wif']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @wif.nil?
        invalid_properties.push('invalid value for "wif", wif cannot be nil.')
      end
    ...
    def hash
      [addresses, private_key, public_key, wif].hash
    end
