  ...
  class ListUnspentTransactionOutputsByAddressRIBlockchainSpecific
    ...
    def self.openapi_types
      {
        ...
        :'v_join_split' => :'Array<ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit>',
        :'v_shielded_output' => :'Array<ListConfirmedTransactionsByAddressRIBSZVShieldedOutput>',
        :'v_shielded_spend' => :'Array<ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::ListUnspentTransactionOutputsByAddressRIBlockchainSpecific` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::ListUnspentTransactionOutputsByAddressRIBlockchainSpecific`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [v_size, binding_sig, expiry_height, join_split_pub_key, join_split_sig, overwintered, v_join_split, v_shielded_output, v_shielded_spend, value_balance, version_group_id].hash
    end
