...
module OpenapiClient
  class ListOmniTransactionsByBlockHeightResponseItem
    ...
    attr_accessor :position_in_block
    ...
    def self.openapi_types
      {
        ...
        :'property_id' => :'Integer',
        :'recipients' => :'Array<ListOmniTransactionsByBlockHeightResponseItemRecipients>',
        :'senders' => :'Array<ListOmniTransactionsByBlockHeightResponseItemSenders>',
        :'timestamp' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ListOmniTransactionsByBlockHeightResponseItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ListOmniTransactionsByBlockHeightResponseItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'position_in_block')
        self.position_in_block = attributes[:'position_in_block']
      end
    ...
    def list_invalid_properties
      ...
      if @position_in_block.nil?
        invalid_properties.push('invalid value for "position_in_block", position_in_block cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @position_in_block.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          position_in_block == o.position_in_block &&
    ...
    def hash
      [amount, divisible, mined_in_block_hash, mined_in_block_height, position_in_block, property_id, recipients, senders, timestamp, transaction_id, type, type_int, valid, version, fee].hash
    end
