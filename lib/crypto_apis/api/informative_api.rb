...
module CryptoApis
  class InformativeApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(ListAllAssetsByWalletIDR, Integer, Hash)>] ListAllAssetsByWalletIDR data, response status code and response headers
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListAllAssetsFromAllWalletsR, Integer, Hash)>] ListAllAssetsFromAllWalletsR data, response status code and response headers
