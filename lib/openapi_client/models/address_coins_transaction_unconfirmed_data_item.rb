  ...
  class AddressCoinsTransactionUnconfirmedDataItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AddressCoinsTransactionUnconfirmedDataItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AddressCoinsTransactionUnconfirmedDataItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('String', ["btc", "satoshi", "wei", "gwei", "eth", "doge", "dash", "etc", "xrp", "zil"])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ["btc", "satoshi", "wei", "gwei", "eth", "doge", "dash", "etc", "xrp", "zil"])
    ...
    def hash
      [blockchain, network, address, transaction_id, amount, unit, direction, first_seen_in_mempool_timestamp].hash
    end
