...
module CryptoApis
  class NewConfirmedTokenTransactionsForSpecificAmountRI
    ...
    attr_accessor :amount_higher_than
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::NewConfirmedTokenTransactionsForSpecificAmountRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::NewConfirmedTokenTransactionsForSpecificAmountRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'amount_higher_than')
        self.amount_higher_than = attributes[:'amount_higher_than']
      end
    ...
    def list_invalid_properties
      ...
      if @amount_higher_than.nil?
        invalid_properties.push('invalid value for "amount_higher_than", amount_higher_than cannot be nil.')
      end
    ...
    def valid?
      return false if @amount_higher_than.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount_higher_than == o.amount_higher_than &&
    ...
    def hash
      [amount_higher_than, callback_secret_key, callback_url, contract_address, created_timestamp, event_type, is_active, reference_id].hash
    end
