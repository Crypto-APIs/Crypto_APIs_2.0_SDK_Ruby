...
# Unit tests for OpenapiClient::CreateAutomaticCoinsForwardingResponseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateAutomaticCoinsForwardingResponseItem do
  let(:instance) { OpenapiClient::CreateAutomaticCoinsForwardingResponseItem.new }

  describe 'test an instance of CreateAutomaticCoinsForwardingResponseItem' do
    it 'should create an instance of CreateAutomaticCoinsForwardingResponseItem' do
      expect(instance).to be_instance_of(OpenapiClient::CreateAutomaticCoinsForwardingResponseItem)
    end
  end
