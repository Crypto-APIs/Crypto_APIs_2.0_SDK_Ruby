...
# Unit tests for OpenapiClient::AddressTokensTransactionUnconfirmedDataItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddressTokensTransactionUnconfirmedDataItem do
  let(:instance) { OpenapiClient::AddressTokensTransactionUnconfirmedDataItem.new }
  ...
  describe 'test an instance of AddressTokensTransactionUnconfirmedDataItem' do
    it 'should create an instance of AddressTokensTransactionUnconfirmedDataItem' do
      expect(instance).to be_instance_of(OpenapiClient::AddressTokensTransactionUnconfirmedDataItem)
    end
  end
