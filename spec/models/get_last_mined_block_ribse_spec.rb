...
# Unit tests for CryptoApis::GetLastMinedBlockRIBSE
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::GetLastMinedBlockRIBSE do
  let(:instance) { CryptoApis::GetLastMinedBlockRIBSE.new }

  describe 'test an instance of GetLastMinedBlockRIBSE' do
    it 'should create an instance of GetLastMinedBlockRIBSE' do
      expect(instance).to be_instance_of(CryptoApis::GetLastMinedBlockRIBSE)
    end
  end
