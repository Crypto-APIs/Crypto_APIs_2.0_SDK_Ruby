...
# Unit tests for CryptoApis::AddTokensToExistingFromAddressRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::AddTokensToExistingFromAddressRI do
  let(:instance) { CryptoApis::AddTokensToExistingFromAddressRI.new }

  describe 'test an instance of AddTokensToExistingFromAddressRI' do
    it 'should create an instance of AddTokensToExistingFromAddressRI' do
      expect(instance).to be_instance_of(CryptoApis::AddTokensToExistingFromAddressRI)
    end
  end
