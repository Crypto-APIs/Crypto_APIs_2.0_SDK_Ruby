...
# Unit tests for CryptoApis::GetLastMinedBlockRIBSBSC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::GetLastMinedBlockRIBSBSC do
  let(:instance) { CryptoApis::GetLastMinedBlockRIBSBSC.new }

  describe 'test an instance of GetLastMinedBlockRIBSBSC' do
    it 'should create an instance of GetLastMinedBlockRIBSBSC' do
      expect(instance).to be_instance_of(CryptoApis::GetLastMinedBlockRIBSBSC)
    end
  end
