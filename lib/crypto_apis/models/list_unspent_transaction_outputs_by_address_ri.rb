  ...
  class ListUnspentTransactionOutputsByAddressRI
    ...
    def self.openapi_types
      {
        ...
        :'senders' => :'Array<ListUnspentTransactionOutputsByAddressRISenders>',
        :'size' => :'Integer',
        :'timestamp' => :'Integer',
        :'transaction_hash' => :'String',
        :'transaction_id' => :'String',
        :'version' => :'Integer',
        :'vin' => :'Array<ListUnspentTransactionOutputsByAddressRIVin>',
        :'vout' => :'Array<ListConfirmedTransactionsByAddressRIBSBVout>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::ListUnspentTransactionOutputsByAddressRI` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::ListUnspentTransactionOutputsByAddressRI`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [index, locktime, mined_in_block_hash, mined_in_block_height, recipients, senders, size, timestamp, transaction_hash, transaction_id, version, vin, vout, fee, blockchain_specific].hash
    end
