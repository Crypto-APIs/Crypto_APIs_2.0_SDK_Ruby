...
# Unit tests for CryptoApis::DeleteAutomaticCoinsForwardingResponseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::DeleteAutomaticCoinsForwardingResponseItem do
  let(:instance) { CryptoApis::DeleteAutomaticCoinsForwardingResponseItem.new }
  ...
  describe 'test an instance of DeleteAutomaticCoinsForwardingResponseItem' do
    it 'should create an instance of DeleteAutomaticCoinsForwardingResponseItem' do
      expect(instance).to be_instance_of(CryptoApis::DeleteAutomaticCoinsForwardingResponseItem)
    end
  end
