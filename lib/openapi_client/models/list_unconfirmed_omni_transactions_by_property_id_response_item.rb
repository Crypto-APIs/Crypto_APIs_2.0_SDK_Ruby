  ...
  class ListUnconfirmedOmniTransactionsByPropertyIDResponseItem
    ...
    def self.openapi_types
      {
        ...
        :'mined' => :'Boolean',
        :'property_id' => :'Integer',
        :'recipients' => :'Array<ListOmniTransactionsByAddressResponseItemRecipients>',
        :'senders' => :'Array<GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders>',
        :'sent' => :'Boolean',
        :'timestamp' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ListUnconfirmedOmniTransactionsByPropertyIDResponseItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ListUnconfirmedOmniTransactionsByPropertyIDResponseItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mined')
        self.mined = attributes[:'mined']
      end
      ...
      if attributes.key?(:'type_iint')
        self.type_iint = attributes[:'type_iint']
      end
    ...
    def list_invalid_properties
      ...
      if @mined.nil?
        invalid_properties.push('invalid value for "mined", mined cannot be nil.')
      end
      ...
      if @type_iint.nil?
        invalid_properties.push('invalid value for "type_iint", type_iint cannot be nil.')
      end
    ...
    def hash
      [amount, divisible, mined, property_id, recipients, senders, sent, timestamp, transaction_id, type, type_iint, version, fee].hash
    end
