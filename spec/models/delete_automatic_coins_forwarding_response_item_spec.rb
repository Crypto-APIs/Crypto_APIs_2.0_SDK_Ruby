...
# Unit tests for OpenapiClient::DeleteAutomaticCoinsForwardingResponseItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeleteAutomaticCoinsForwardingResponseItem do
  let(:instance) { OpenapiClient::DeleteAutomaticCoinsForwardingResponseItem.new }

  describe 'test an instance of DeleteAutomaticCoinsForwardingResponseItem' do
    it 'should create an instance of DeleteAutomaticCoinsForwardingResponseItem' do
      expect(instance).to be_instance_of(OpenapiClient::DeleteAutomaticCoinsForwardingResponseItem)
    end
  end
