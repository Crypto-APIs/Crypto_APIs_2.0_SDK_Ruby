...
module CryptoApis
  class CreateCoinsTransactionRequestFromWalletRBDataItem
    ...
    attr_accessor :prepare_strategy
    ...
    def self.openapi_types
      {
        ...
        :'recipients' => :'Array<CreateCoinsTransactionRequestFromWalletRBDataItemRecipientsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::CreateCoinsTransactionRequestFromWalletRBDataItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::CreateCoinsTransactionRequestFromWalletRBDataItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'prepare_strategy')
        self.prepare_strategy = attributes[:'prepare_strategy']
      else
        self.prepare_strategy = 'minimize-dust'
      end
    ...
    def valid?
      ...
      prepare_strategy_validator = EnumAttributeValidator.new('String', ["minimize-dust", "optimize-size"])
      return false unless prepare_strategy_validator.valid?(@prepare_strategy)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] prepare_strategy Object to be assigned
    def prepare_strategy=(prepare_strategy)
      validator = EnumAttributeValidator.new('String', ["minimize-dust", "optimize-size"])
      unless validator.valid?(prepare_strategy)
        fail ArgumentError, "invalid value for \"prepare_strategy\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          note == o.note &&
          prepare_strategy == o.prepare_strategy &&
    ...
    def hash
      [callback_secret_key, callback_url, fee_priority, note, prepare_strategy, recipients].hash
    end
