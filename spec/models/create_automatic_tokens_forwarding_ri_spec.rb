...
# Unit tests for CryptoApis::CreateAutomaticTokensForwardingRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::CreateAutomaticTokensForwardingRI do
  let(:instance) { CryptoApis::CreateAutomaticTokensForwardingRI.new }

  describe 'test an instance of CreateAutomaticTokensForwardingRI' do
    it 'should create an instance of CreateAutomaticTokensForwardingRI' do
      expect(instance).to be_instance_of(CryptoApis::CreateAutomaticTokensForwardingRI)
    end
  end
