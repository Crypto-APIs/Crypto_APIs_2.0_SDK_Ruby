...
# Unit tests for CryptoApis::DeleteAutomaticTokensForwardingRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::DeleteAutomaticTokensForwardingRI do
  let(:instance) { CryptoApis::DeleteAutomaticTokensForwardingRI.new }

  describe 'test an instance of DeleteAutomaticTokensForwardingRI' do
    it 'should create an instance of DeleteAutomaticTokensForwardingRI' do
      expect(instance).to be_instance_of(CryptoApis::DeleteAutomaticTokensForwardingRI)
    end
  end
