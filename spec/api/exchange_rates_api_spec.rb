...
describe 'ExchangeRatesApi' do
  ...
  # @option opts [Integer] :calculation_timestamp Defines the time of the market data used to calculate the exchange rate in UNIX Timestamp. Oldest possible timestamp is 30 days.
