...
describe 'XRPRippleApi' do
  ...
  # unit tests for list_xrp__ripple_transactions_by_address_and_time_range
  ...
  # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis.
  # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items.
  # @option opts [String] :transaction_type Defines the transaction type.
  # @return [ListXRPRippleTransactionsByAddressAndTimeRangeR]
  describe 'list_xrp__ripple_transactions_by_address_and_time_range test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
