...
describe 'FeaturesApi' do
  ...
  # unit tests for convert_bitcoin_cash_address
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
  # @option opts [ConvertBitcoinCashAddressRB] :convert_bitcoin_cash_address_rb 
  # @return [ConvertBitcoinCashAddressR]
  describe 'convert_bitcoin_cash_address test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
