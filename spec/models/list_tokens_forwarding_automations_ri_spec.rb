...
# Unit tests for CryptoApis::ListTokensForwardingAutomationsRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::ListTokensForwardingAutomationsRI do
  let(:instance) { CryptoApis::ListTokensForwardingAutomationsRI.new }

  describe 'test an instance of ListTokensForwardingAutomationsRI' do
    it 'should create an instance of ListTokensForwardingAutomationsRI' do
      expect(instance).to be_instance_of(CryptoApis::ListTokensForwardingAutomationsRI)
    end
  end
