...
module CryptoApis
  class XRPRippleApi
    ...
    def get_latest_mined_xrp__ripple_block_with_http_info(network, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/blocks/last'.sub('{' + 'network' + '}', CGI.escape(network.to_s))
    ...
    def get_xrp__ripple_address_details_with_http_info(network, address, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/addresses/{address}'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'address' + '}', CGI.escape(address.to_s))
    ...
    def get_xrp__ripple_block_details_by_block_hash_with_http_info(network, block_hash, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/blocks/hash/{blockHash}'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'blockHash' + '}', CGI.escape(block_hash.to_s))
    ...
    def get_xrp__ripple_block_details_by_block_height_with_http_info(network, height, opts = {})
      ...
      if @api_client.config.client_side_validation && height.nil?
        fail ArgumentError, "Missing the required parameter 'height' when calling XRPRippleApi.get_xrp__ripple_block_details_by_block_height"
      end
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/blocks/height/{height}'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'height' + '}', CGI.escape(height.to_s))
    ...
    def get_xrp__ripple_transaction_details_by_transaction_id_with_http_info(network, transaction_hash, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/transactions/{transactionHash}'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'transactionHash' + '}', CGI.escape(transaction_hash.to_s))
    ...
    def list_xrp__ripple_transactions_by_address_with_http_info(network, address, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/addresses/{address}/transactions'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'address' + '}', CGI.escape(address.to_s))
    ...
    def list_xrp__ripple_transactions_by_block_hash_with_http_info(network, block_hash, opts = {})
      ...
      # resource path
      local_var_path = '/blockchain-data/xrp/{network}/blocks/hash/{blockHash}/transactions'.sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'blockHash' + '}', CGI.escape(block_hash.to_s))
