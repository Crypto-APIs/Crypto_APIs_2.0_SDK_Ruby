...
module CryptoApis
  class UnifiedEndpointsApi
    ...
    # @option opts [Integer] :confirmation_target Integer representation of confirmation target in blocks that estimation will be valid for
    # @option opts [String] :estimate_mode String representation of the address
    # @return [Array<(EstimateTransactionSmartFeeR, Integer, Hash)>] EstimateTransactionSmartFeeR data, response status code and response headers
    ...
    def get_address_balance(blockchain, network, address, opts = {})
      data, _status_code, _headers = get_address_balance_with_http_info(blockchain, network, address, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(GetAddressBalanceR, Integer, Hash)>] GetAddressBalanceR data, response status code and response headers
    def get_address_balance_with_http_info(blockchain, network, address, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnifiedEndpointsApi.get_address_balance ...'
      end
      # verify the required parameter 'blockchain' is set
      if @api_client.config.client_side_validation && blockchain.nil?
        fail ArgumentError, "Missing the required parameter 'blockchain' when calling UnifiedEndpointsApi.get_address_balance"
      end
      # verify enum value
      allowable_values = ["bitcoin", "ethereum", "ethereum-classic", "binance-smart-chain", "bitcoin-cash", "litecoin", "dash", "dogecoin", "xrp", "tron"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
      if @api_client.config.client_side_validation && network.nil?
        fail ArgumentError, "Missing the required parameter 'network' when calling UnifiedEndpointsApi.get_address_balance"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && address.nil?
        fail ArgumentError, "Missing the required parameter 'address' when calling UnifiedEndpointsApi.get_address_balance"
      end
      # resource path
      local_var_path = '/blockchain-data/{blockchain}/{network}/addresses/{address}/balance'.sub('{' + 'blockchain' + '}', CGI.escape(blockchain.to_s)).sub('{' + 'network' + '}', CGI.escape(network.to_s)).sub('{' + 'address' + '}', CGI.escape(address.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAddressBalanceR'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['ApiKey']

      new_options = opts.merge(
        :operation => :"UnifiedEndpointsApi.get_address_balance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UnifiedEndpointsApi#get_address_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_block_details_by_block_hash_with_http_info(blockchain, network, block_hash, opts = {})
      ...
      # verify enum value
      allowable_values = ["bitcoin", "ethereum", "ethereum-classic", "bitcoin-cash", "litecoin", "dogecoin", "dash", "binance-smart-chain", "zcash", "zilliqa"]
      if @api_client.config.client_side_validation && !allowable_values.include?(blockchain)
        fail ArgumentError, "invalid value for \"blockchain\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'network' is set
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(GetLastMinedBlockR, Integer, Hash)>] GetLastMinedBlockR data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(GetNextAvailableNonceR, Integer, Hash)>] GetNextAvailableNonceR data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(GetRawTransactionDataR, Integer, Hash)>] GetRawTransactionDataR data, response status code and response headers
    ...
    # @param network [String] Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot; are test networks.
    # @param address [String] Represents the public address, which is a compressed and shortened form of a public key.
    # @param from_timestamp [Integer] Defines the specific time/date from which the results will start being listed.
    # @param to_timestamp [Integer] Defines the specific time/date to which the results will be listed.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListConfirmedTokensTransfersByAddressAndTimeRangeR, Integer, Hash)>] ListConfirmedTokensTransfersByAddressAndTimeRangeR data, response status code and response headers
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListConfirmedTransactionsByAddressR, Integer, Hash)>] ListConfirmedTransactionsByAddressR data, response status code and response headers
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListConfirmedTransactionsByAddressAndTimeRangeR, Integer, Hash)>] ListConfirmedTransactionsByAddressAndTimeRangeR data, response status code and response headers
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListInternalTransactionsByAddressAndTimeRangeR, Integer, Hash)>] ListInternalTransactionsByAddressAndTimeRangeR data, response status code and response headers
    ...
    # @param network [String] Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot; are test networks
    # @param blockchain [String] Represents the specific blockchain protocol name, e.g. Ethereum, Bitcoin, etc.
    # @param count [Integer] Specifies how many records were requested.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user.
    # @return [Array<(ListLatestMinedBlocksR, Integer, Hash)>] ListLatestMinedBlocksR data, response status code and response headers
    def list_latest_mined_blocks_with_http_info(network, blockchain, count, opts = {})
      ...
      # verify enum value
      allowable_values = ["testnet", "mordor", "mainnet", "goerli"]
      if @api_client.config.client_side_validation && !allowable_values.include?(network)
        fail ArgumentError, "invalid value for \"network\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'blockchain' is set
    ...
    def list_transactions_by_block_hash_with_http_info(blockchain, network, block_hash, opts = {})
      ...
      # verify enum value
      allowable_values = ["testnet", "mainnet", "mordor", "goerli"]
      if @api_client.config.client_side_validation && !allowable_values.include?(network)
        fail ArgumentError, "invalid value for \"network\", must be one of #{allowable_values}"
      end
      # verify the required parameter 'block_hash' is set
    ...
    # @option opts [Integer] :limit Defines how many items should be returned in the response per page basis. (default to 50)
    # @option opts [Integer] :offset The starting index of the response items, i.e. where the response should start listing the returned items. (default to 0)
    # @return [Array<(ListUnconfirmedTransactionsByAddressR, Integer, Hash)>] ListUnconfirmedTransactionsByAddressR data, response status code and response headers
