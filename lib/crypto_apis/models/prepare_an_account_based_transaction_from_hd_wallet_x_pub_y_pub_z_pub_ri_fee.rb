  ...
  class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CryptoApis::PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CryptoApis::PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @max_fee_per_gas.nil?
        invalid_properties.push('invalid value for "max_fee_per_gas", max_fee_per_gas cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @max_fee_per_gas.nil?
    ...
    def hash
      [gas_limit, gas_price, max_fee_per_gas, max_priority_fee_per_gas].hash
    end
