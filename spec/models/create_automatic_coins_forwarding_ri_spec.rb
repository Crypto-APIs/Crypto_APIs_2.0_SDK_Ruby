...
# Unit tests for CryptoApis::CreateAutomaticCoinsForwardingRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::CreateAutomaticCoinsForwardingRI do
  let(:instance) { CryptoApis::CreateAutomaticCoinsForwardingRI.new }

  describe 'test an instance of CreateAutomaticCoinsForwardingRI' do
    it 'should create an instance of CreateAutomaticCoinsForwardingRI' do
      expect(instance).to be_instance_of(CryptoApis::CreateAutomaticCoinsForwardingRI)
    end
  end
