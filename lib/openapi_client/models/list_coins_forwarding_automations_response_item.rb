...
module OpenapiClient
  class ListCoinsForwardingAutomationsResponseItem
    ...
    attr_accessor :confirmations_count_trigger
    ...
    def self.openapi_types
      {
        :'callback_url' => :'String',
        :'confirmations_count_trigger' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ListCoinsForwardingAutomationsResponseItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ListCoinsForwardingAutomationsResponseItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confirmations_count_trigger')
        self.confirmations_count_trigger = attributes[:'confirmations_count_trigger']
      end
    ...
    def list_invalid_properties
      ...
      if @confirmations_count_trigger.nil?
        invalid_properties.push('invalid value for "confirmations_count_trigger", confirmations_count_trigger cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @confirmations_count_trigger.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          confirmations_count_trigger == o.confirmations_count_trigger &&
    ...
    def hash
      [callback_url, confirmations_count_trigger, created_timestamp, fee_priority, from_address, minimum_transfer_amount, reference_id, to_address].hash
    end
