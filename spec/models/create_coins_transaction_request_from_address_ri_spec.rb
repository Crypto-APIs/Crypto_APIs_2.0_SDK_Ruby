...
# Unit tests for CryptoApis::CreateCoinsTransactionRequestFromAddressRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::CreateCoinsTransactionRequestFromAddressRI do
  let(:instance) { CryptoApis::CreateCoinsTransactionRequestFromAddressRI.new }

  describe 'test an instance of CreateCoinsTransactionRequestFromAddressRI' do
    it 'should create an instance of CreateCoinsTransactionRequestFromAddressRI' do
      expect(instance).to be_instance_of(CryptoApis::CreateCoinsTransactionRequestFromAddressRI)
    end
  end
