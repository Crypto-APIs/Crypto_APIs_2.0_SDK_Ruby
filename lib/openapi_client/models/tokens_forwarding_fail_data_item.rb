...
module OpenapiClient
  ...
  class TokensForwardingFailDataItem
    ...
    attr_accessor :trigger_transaction_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TokensForwardingFailDataItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TokensForwardingFailDataItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      error_code_validator = EnumAttributeValidator.new('String', ["NOT_ENOUGH_CREDITS", "FEE_ADDRESS_OUT_OF_FUNDS", "WRONG_ADDRESS_CREDENTIALS"])
    ...
    def error_code=(error_code)
      validator = EnumAttributeValidator.new('String', ["NOT_ENOUGH_CREDITS", "FEE_ADDRESS_OUT_OF_FUNDS", "WRONG_ADDRESS_CREDENTIALS"])
    ...
    def hash
      [blockchain, network, from_address, to_address, trigger_transaction_id, error_code, error_message].hash
    end
