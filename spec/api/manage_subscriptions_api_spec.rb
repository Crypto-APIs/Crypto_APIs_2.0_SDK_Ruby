...
describe 'ManageSubscriptionsApi' do
  ...
  # unit tests for activate_blockchain_event_subscription
  ...
  describe 'activate_blockchain_event_subscription test' do
    it 'should work' do
  ...
  # unit tests for get_blockchain_event_subscription_details_by_reference_id
  ...
  describe 'get_blockchain_event_subscription_details_by_reference_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
