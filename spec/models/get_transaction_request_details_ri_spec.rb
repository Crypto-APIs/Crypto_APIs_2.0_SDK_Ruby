...
# Unit tests for CryptoApis::GetTransactionRequestDetailsRI
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CryptoApis::GetTransactionRequestDetailsRI do
  let(:instance) { CryptoApis::GetTransactionRequestDetailsRI.new }

  describe 'test an instance of GetTransactionRequestDetailsRI' do
    it 'should create an instance of GetTransactionRequestDetailsRI' do
      expect(instance).to be_instance_of(CryptoApis::GetTransactionRequestDetailsRI)
    end
  end
  ...
  describe 'test attribute "blockchain"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["bitcoin", "bitcoin-cash", "litecoin", "dogecoin", "dash", "ethereum", "ethereum-classic", "xrp", "zcash"])
      # validator.allowable_values.each do |value|
      #   expect { instance.blockchain = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "network"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["mainnet", "testnet", "ropsten", "mordor"])
      # validator.allowable_values.each do |value|
